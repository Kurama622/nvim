...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'galaxyline.nvim', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
