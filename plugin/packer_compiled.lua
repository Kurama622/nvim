...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'galaxyline.nvim', 'indent-blankline.nvim', 'friendly-snippets', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
