...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-lua", "cmp_luasnip", "nvim-autopairs" },
  ...
  ["nvim-web-devicons"] = {
    loaded = true,
    path = "/home/vegeta/.local/share/nvim/site/pack/packer/start/nvim-web-devicons",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-treesitter', 'friendly-snippets', 'galaxyline.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
