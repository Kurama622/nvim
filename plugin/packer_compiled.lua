...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'galaxyline.nvim', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
