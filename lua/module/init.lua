...
-- require('module.indent-blankline')   -- $HOME/.config/nvim/lua/module/indent-blankline.lua  (lazy load)
-- require('module.telescope')          -- $HOME/.config/nvim/lua/module/telescope.lua         (lazy load)
-- require('module.statusline')         -- $HOME/.config/nvim/lua/module/statusline.lua        (lazy load)
-- require('module.treesitter')         -- $HOME/.config/nvim/lua/module/treesitter.lua        (lazy load)
